...
- For Active-Active databases, you must upgrade the [feature set version]({{< relref "/rs/installing-upgrading/upgrading.md#upgrading-active-active-databases" >}}).
...
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph.md" >}}), version [2.0.10]({{< relref "/modules/redisgraph/release-notes/redisgraph-2.0-release-notes.md" >}})
...
For more info and examples, check out [upgrading Redis Modules documentation]({{< relref "/modules/add-module-to-cluster.md#upgrading-the-module-for-the-database" >}}) .
...
- When you upgrade an Active-Active Redis with active AOF from version [RS 5.4.2]({{< relref "/rs/release-notes/rs-5-4-2-april-2019.md" >}}) or lower to version [RS 5.4.4]({{< relref "/rs/release-notes/rs-5-4-4-june-2019.md" >}}) or higher:
