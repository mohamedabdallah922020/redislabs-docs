...
If you are using [geo-distributed CRDBs]({{< relref "/rs/concepts/intercluster-replication.md" >}}), it is critical to use [Network Time Service (ntpd)]({{< relref "/rs/administering/designing-production/active-active.md#network-time-service-ntp-or-chrony" >}})
